const fs = require('fs');
const content = `import React, { useState, useRef, useEffect, useCallback } from 'react';
...
`;
fs.writeFileSync('src/apps/HydrostaticPressure/HydrostaticPressure.tsx', content);